...
class WeakSignalTests: XCTestCase {
    typealias TargetType = WeakTarget<Int, Signal<Int>>
    ...
    override func setUp() {
        ...
        self.target = .init(sequence: self.source.asSignal(onErrorJustReturn: 0)) {
            self.events = $0
        }
